...
return [
    ...
    'session_sync'                         => env('KEYCLOAK_SESSION_SYNC', false),
    // if true, it will sync the session with keycloak on each request
    'keycloak_url'                         => env('KEYCLOAK_URL', 'http://localhost:8080/auth'),
